...
function init_globe(){
	...
	function draw_globe(item) {
		queue()
			.defer(d3.json,
				"https://raw.githubusercontent.com/Vikr-182/Air-Accidents-Visualizer/refs/heads/master/assets/static/world-110m.json"
			)
			.defer(d3.json, "https://raw.githubusercontent.com/Vikr-182/Air-Accidents-Visualizer/refs/heads/master/data/places.json")
			.defer(d3.json, "https://raw.githubusercontent.com/Vikr-182/Air-Accidents-Visualizer/refs/heads/master/data/tmc.json")
			.defer(d3.json, "https://raw.githubusercontent.com/Vikr-182/Air-Accidents-Visualizer/refs/heads/master/assets/static/code_to_airport.json")
			.defer(d3.json, "https://raw.githubusercontent.com/Vikr-182/Air-Accidents-Visualizer/refs/heads/master/data/cleaned_data.json")
			.await(ready);
		// enable zoom
		var zoom = d3.zoom()
		...
		function ready(error, json, places, new_places, code_to_airport, cleaned_data) {
			...
			// links = links.filter(d => d["date"] == item?);
	...
	myFunction();
	// d3.selectAll("#20000525-2").remove();	
var extra = 
{
	"2000": 22008658,
	"2001":22264220,
